...
namespace WebSiteRestaurante.DataSet.DataSetTaxaServicoTableAdapters {
    ...
    public partial class TAXA_SERVICOTableAdapter : global::System.ComponentModel.Component {
        ...
        public virtual int Fill(DataSetTaxaServico.TAXA_SERVICODataTable dataTable, string DATA_INICIO, string DATA_FIM) {
        ...
        public virtual DataSetTaxaServico.TAXA_SERVICODataTable GetData(string DATA_INICIO, string DATA_FIM) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((DATA_INICIO == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
