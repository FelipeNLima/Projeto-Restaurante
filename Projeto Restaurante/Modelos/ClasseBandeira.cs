    ...
    class ClasseBandeira
    {
        ...
        public bool CadastrarBandeira()
        {
            ...
            try
            {
                ...
                string sql = " INSERT INTO BANDEIRA_CARTAO (nome_bandeiras, taxa, apagado, id_formaPagamento) VALUES (@NOMEBANDEIRA, @TAXA, @APAGADO, @IDFORMAPAGAMENTO)";
        ...
        public bool AtualizarBandeira()
        {
            ...
            try
            {
                ...
                string sql = "UPDATE BANDEIRA_CARTAO SET  nome_bandeiras = @NOMEBANDEIRA, taxa = @TAXA, apagado = @APAGADO, id_formaPagamento=@IDFORMAPAGAMENTO WHERE id_bandeiras = @IDBANDEIRA";
        ...
        public void CarregarPorID(int id)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT nome_bandeiras, taxa, id_formaPagamento FROM BANDEIRA_CARTAO WHERE id_bandeiras = @ID", obj.objCon);
        ...
        public static List<ClasseBandeira> CarregarBandeira()
        {

            {
                ...
                try
                {
                    ...
                    SqlDataReader Leitor = null;
                    SqlCommand cmd = new SqlCommand("SELECT id_bandeiras,nome_bandeiras,taxa,apagado,id_formaPagamento FROM BANDEIRA_CARTAO WHERE apagado = 0", obj.objCon);
                    Leitor = cmd.ExecuteReader();
